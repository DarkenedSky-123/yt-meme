...
if __name__ == "__main__":
    original_video_path = 'assets/outro.mp4'
    ...
    final_output_path = 'Python Files/final_outro.mp4'
...
# Sample data for the arrays
    ...
    text_info = [
        {'text': "Like and subscribe", 'font_scale': 12, 'color': (255, 255, 255), 'border_color': (0, 0, 0), 'thickness': 20, 'timestamp': 0.00, 'end_timestamp': 2.00, 'position': (100, 200)},
        {'text': 'OR', 'font_scale': 20, 'color': (255, 255, 255), 'border_color': (0, 0, 0), 'thickness': 20, 'timestamp': 0.00, 'end_timestamp': 2.00, 'position': (440, 300)},
        {'text': "You'll have one \nyear of bad luck ", 'font_scale': 13, 'color': (255, 0,0 ), 'border_color': (0, 0, 0), 'thickness': 20, 'timestamp': 0.00, 'end_timestamp': 2.00, 'position': (100, 500)},
        # {'text': random_action, 'font_scale': 20, 'color': (255, 255, 255), 'border_color': (0, 0, 0), 'thickness': 20, 'timestamp': 2.00, 'end_timestamp': 1.83, 'position': (350, 350)}
    ]

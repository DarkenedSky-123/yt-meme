...
def get_authenticated_service():
    ...
    if os.path.exists('credentials/meme.pickle'):
        with open('credentials/meme.pickle', 'rb') as token_file:
    ...
    if not credentials or not credentials.valid:
        ...
        with open('credentials/meme.pickle', 'wb') as token_file:
            ...
            if response is not None:
                if 'id' in response:
                    with open("Data/Video.txt","r")as f:
                        idd = f.readline().strip() #https://www.youtube.com/shorts/q1X4ilvQvt4
                    # comm(f"Watch next :\n► https://www.youtube.com/shorts/{idd}","seal",get_latest_video("UCT0vmR76yrI__1W2W6ELMxA"))
...
def main():
    ...
    default_title ="OFFENSIVE MEMES"" #viral #shorts #meme"
